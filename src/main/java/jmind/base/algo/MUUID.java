...
* </table>
* </pre></blockquote>
* 24位uuid ，保证不重复，且包含时间信息
* @dochub objectids
*/
public class MUUID implements Comparable<MUUID>, java.io.Serializable {
     ...
     */
    public static MUUID massageToObjectId(Object o) {
        if (o == null)
            return null;

        if (o instanceof MUUID)
            return (MUUID) o;
    ...
    public MUUID(Date time) {
        this(time, _genmachine, _nextInc.getAndIncrement());
    }

    public MUUID(Date time, int inc) {
        this(time, _genmachine, inc);
    }

    public MUUID(Date time, int machine, int inc) {
     ...
     */
    public MUUID(String s) {
        this(s, false);
    }

    public MUUID(String s, boolean babble) {
     ...
     */
    public MUUID(int time, int machine, int inc) {
        _time = time;
        _machine = machine;
        _inc = inc;
        _new = false;
    ...
    /**
     * create a new object id by machine
     * @param machine
     */
    public MUUID(int machine) {
        _time = (int) (System.currentTimeMillis() / 1000);
        _machine = machine;
        _inc = _nextInc.getAndIncrement();
        _new = true;
    ...
    public boolean equals(Object o) {
        ...
        MUUID other = massageToObjectId(o);
        if (other == null)
            return false;
